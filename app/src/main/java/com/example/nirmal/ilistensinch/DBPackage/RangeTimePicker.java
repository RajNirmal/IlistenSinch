...
public class RangeTimePicker extends TimePickerDialog {
    ...
    public RangeTimePicker(Context context, TimePickerDialog.OnTimeSetListener callBack, int hourOfDay, int minute, boolean is24HourView) {
